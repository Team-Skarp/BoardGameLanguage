...
import symboltable.types.builtin.BuiltInType;
import symboltable.types.builtin.Tile;
...
public class TypeEnvironment {
    ...
    public static TypeEnvironment init() {
        ...
        List<BuiltInType> builtInTypes = List.of(tile);
...
//        }
     ...
     * @param type
     */
    private static DesignType initType(BuiltInType type) {
